...
\textbf{Solution :}
  ...
  Let us define random variables $X$,$Y$, where $X,Y \in \cbrak{0,1}$ ,such that
       \begin{table}[ht!]
        ...
        \label{table:table 2}
       \end{table}\\
       From \ref{table:table 1} we can write,
          \begin{align}
               \pr{X = 1} &= \frac{30}{60} \\
                               &=\frac{1}{2}\\
               \pr{Y = 1} &= \frac{32}{60} \\
          ...
          \end{align}
    \begin{enumerate}[label = (\roman*)]
       \item The probability of the event "the student opted for NCC or NSS" can be described as $\pr{\brak{X = 1} + \brak{Y = 1}}$. In other words, either of random variables $X,Y$ should be equal to 1.
                 ...
                 \end{align}
       \item The probability of the event "the student has opted neither NCC nor NSS" can be described as "$ \pr{X=0,Y=0}$ ".In other words,both the random                         
                variables $X,Y$ should be 0.  
                 Now we can write,
                 \begin{align}
	            ...
	            \pr{X=0,Y=0} &= 1 - \frac{19}{30}\\
                                         &= \frac{11}{30}                        
                 \end{align}
       \item The probability of the event "the student has opted NSS but not NCC" can be described as  "$\pr{Y=1 , X=0}$". \\
                We can write 
                 \begin{equation}
                 \begin{split}
                   \pr{Y = 1 , X = 0} = \pr{Y = 1} \\
