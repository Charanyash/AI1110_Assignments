...
\bigskip
\begin{abstract}
   This document provides solution of Assignment 2(ICSE 2019 12 Q.5(a))
\end{abstract}
  ...
  Given  
   ...
   We can say f is continuous at $x = 4$,iff 
    ...
    In that case f should satisfy,
            \begin{align}
                 \lim_{h \to 0}\frac{f\brak{4 + h} - f\brak{4}}{h}  &=  lim_{h \to 0}\frac{f\brak{4} - f\brak{4-h}}{h}\label{eq 12} % LHD = RHD
            \end{align}
 \textbf{LHS:}
